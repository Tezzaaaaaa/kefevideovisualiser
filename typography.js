...
(() => {
  ...
  const families={ui:'Open Sans',apple:'Open Sans',brat:'Arial Narrow',eternal:'Homemade Apple',aurora:'Permanent Marker',typewriter:'Triplicate, Courier Prime',instagram:'Arial Narrow',fadeup:'DM Sans',mixedmedia:'Open Sans'};
  const effects={
    ...
    instagram:{family:families.instagram,weight:800,min:48,max:150,lineHeight:.82,tracking:-.025,align:'center',case:'upper'},
