...
(() => {
  ...
  const families = { ui:'Open Sans', apple:'Open Sans', brat:'Arial Narrow', eternal:'Homemade Apple', aurora:'Permanent Marker', starwars:'Open Sans', stroke:'Montserrat', fadeup:'DM Sans' };
  const effects = {
