const CACHE='story-lyrics-v12-final';
const ASSETS=['/','/index.html','/styles.css','/app.js','/mobile.js','/media_store.js','/export.js','/polish.js','/manifest.webmanifest','/icons/icon-192.png','/icons/icon-512.png'];
