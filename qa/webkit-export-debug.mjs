...
console.log('WEBKIT CAPABILITIES',await page.evaluate(()=>({
  ...
  canvasMozCaptureStream:!!HTMLCanvasElement.prototype.mozCaptureStream,
  canvasWebkitCaptureStream:!!HTMLCanvasElement.prototype.webkitCaptureStream,
  videoCaptureStream:!!HTMLVideoElement.prototype.captureStream,
  videoMozCaptureStream:!!HTMLVideoElement.prototype.mozCaptureStream,
  videoWebkitCaptureStream:!!HTMLVideoElement.prototype.webkitCaptureStream,
  mediaElementCaptureStream:!!HTMLMediaElement.prototype.captureStream,
  mediaElementMozCaptureStream:!!HTMLMediaElement.prototype.mozCaptureStream,
  mediaElementWebkitCaptureStream:!!HTMLMediaElement.prototype.webkitCaptureStream,
  mediaRecorder:!!window.MediaRecorder,
  mediaStreamTrackProcessor:!!window.MediaStreamTrackProcessor,
  mediaStreamTrackGenerator:!!window.MediaStreamTrackGenerator,
  ...
  canvasCaptureMediaStreamTrack:!!window.CanvasCaptureMediaStreamTrack,
  imageCapture:!!window.ImageCapture,
  requestVideoFrameCallback:!!HTMLVideoElement.prototype.requestVideoFrameCallback,
  ...
  mime:window.MediaRecorder?{
    ...
    avcAac:MediaRecorder.isTypeSupported('video/mp4;codecs=avc1.42E01E,mp4a.40.2'),
