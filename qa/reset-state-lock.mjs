...
try{
  ...
  const diag=await page.evaluate(()=>({
    ...
    controlAudit:window.linaControlAudit||null,
    resetOnclick:typeof document.querySelector('#resetBtn')?.onclick,
    directHandlers:Object.fromEntries(['saveProgressBtn','exportBtn','exportBottomBtn','resetBtn','cancel'].map(id=>[id,typeof document.querySelector('#'+id)?.onclick])),
