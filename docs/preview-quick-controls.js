  ...
  function build(){
    ...
    box.innerHTML=`
      ...
      <div class="quick-actions">
        <a id="resetProjectVisible" class="btn subtle" href="reset.html?v=p98-20260813-two-column-quick-settings" role="button" data-lina-owner="project-hard-v3">Reset project</a>
