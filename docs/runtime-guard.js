...
(()=>{
  ...
  console.info('LINA startup check passed',{panels:navButtons.length,audioReady:!!audio,exportReady:true,exportLifecycle:true,mediaLifecycle:true,previewRuntime:true,previewRecovery:true});
})();
