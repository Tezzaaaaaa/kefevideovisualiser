...
(()=>{
  ...
  function audit(){
    ...
    require($('#quickResetLayout')?.dataset.linaOwner==='canonical','visible-reset-owner');
    ...
    const result={checked:12,missing,passed:12-missing.length,mode:'read-only',owners:{render:document.documentElement.dataset.renderOwner,layout:document.documentElement.dataset.layoutOwner,effect:document.documentElement.dataset.effectOwner,transport:document.documentElement.dataset.transportOwner,export:document.documentElement.dataset.exportOwner,projectReset:document.documentElement.dataset.projectResetOwner,controls:document.documentElement.dataset.controlsOwner,ui:document.documentElement.dataset.uiOwner}};
