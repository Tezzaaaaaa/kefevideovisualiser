...
(()=>{
  ...
  function audit(){
    ...
    require($('#linaFreshReset')?.dataset.linaOwner==='fresh-direct','fresh-reset-owner');
    require(!$('#quickResetLayout'),'retired-reset-control-present');
